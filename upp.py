...
OFFICIAL_UPSTREAM_REPO = "https://github.com/PROBOYX/HEROKU"
BOT_IS_UP_TO_DATE = "âUltra xis up-to-date!â"
NEW_BOT_UP_DATE_FOUND = (
    "**ULTRA X  Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**ï¹ï¹Updating Ultra X* \n**Version** : `1.0.0` \n**Telethon** : `1.19.5` \n**Status** : `Â«Pulling UpdatesÂ»` \nã**Thank You For Using Ultra X !**ã")
